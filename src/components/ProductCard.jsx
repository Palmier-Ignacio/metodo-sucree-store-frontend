  ...
  return (
    <article className="product-card">
      ...
      <div className="product-card__body">
        ...
        {product.subtitle && (
          <strong className="product-card__subtitle">{product.subtitle}</strong>
        )}
        ...
        <div className="product-card__footer">
          ...
          <div className="product-card__actions">
            <Link className="button button--outline button--small" to={`/producto/${product.id}`}>
              Ver
            </Link>
            ...
            >
              {alreadyOwned ? 'Ya lo tenés' : inCart ? 'En carrito' : 'Comprar'}
            </button>
          </div>
        </div>
      </div>
